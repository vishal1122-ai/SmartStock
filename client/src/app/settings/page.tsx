...
const Settings = () => {
  ...
  useEffect(() => {
    ...
    const darkModeSetting = userSettings.find(
  ...
  return (
    <div className="w-full">
      ...
      <div className="overflow-x-auto mt-5 shadow-md">
        <table className="min-w-full bg-white dark:bg-gray-800 dark:text-white rounded-lg">
              ...
              >
                ...
                <td className="py-2 px-4">
                  {setting.type === "toggle" ? (
                    ...
                    <input
                      type="text"
                      className="px-4 py-2 border rounded-lg text-gray-500 dark:text-gray-300 focus:outline-none focus:border-blue-500 dark:bg-gray-700"
