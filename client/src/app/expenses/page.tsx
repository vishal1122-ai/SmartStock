...
const Expenses = () => {
  ...
  const classNames = {
    ...
    selectInput:
      "mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:ring-teal-500 focus:border-teal-500 sm:text-sm rounded-lg",
  };
                ...
                {aggregatedData.map(
                  (entry: AggregatedDataItem, index: number) => (
                    <Cell
                      ...
                      fill={
                        index === activeIndex
                          ? "rgb(29, 78, 216)" // Highlighted color
                          : entry.color
                      }
                    />
                  )
